...
public class MineboundModSounds {
	...
	public static final RegistryObject<SoundEvent> ORE_BREAKING1_2 = REGISTRY.register("ore_breaking1_2", () -> new SoundEvent(new ResourceLocation("minebound", "ore_breaking1_2")));
}
