...
public class AlienrockaegisaltBlock extends Block {
	public AlienrockaegisaltBlock() {
	...
	public List<ItemStack> getDrops(BlockState state, LootContext.Builder builder) {
		...
		return Collections.singletonList(new ItemStack(MineboundModItems.AEGISALT_ORE.get()));
	}
