...
public class ClaycoalBlock extends Block {
	public ClaycoalBlock() {
		super(BlockBehaviour.Properties.of(Material.STONE, MaterialColor.COLOR_BLACK)
				.sound(new ForgeSoundType(1.0f, 1.0f, () -> new SoundEvent(new ResourceLocation("minebound:ore_breaking1_2")), () -> new SoundEvent(new ResourceLocation("minebound:footstep_clay1")),
				...
				.strength(6.5f, 10f).requiresCorrectToolForDrops());
	}
