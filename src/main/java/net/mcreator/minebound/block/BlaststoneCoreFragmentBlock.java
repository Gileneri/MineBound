...
public class BlaststoneCoreFragmentBlock extends Block {
	public BlaststoneCoreFragmentBlock() {
		super(BlockBehaviour.Properties.of(Material.STONE, MaterialColor.TERRACOTTA_ORANGE)
				...
				.strength(21f, 10f).requiresCorrectToolForDrops());
	}
	...
	public List<ItemStack> getDrops(BlockState state, LootContext.Builder builder) {
		...
		return Collections.singletonList(new ItemStack(MineboundModItems.CORE_FRAGMENT.get()));
	}
