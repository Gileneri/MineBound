...
public class AlienrockgoldBlock extends Block {
	public AlienrockgoldBlock() {
		super(BlockBehaviour.Properties.of(Material.STONE, MaterialColor.GOLD)
	...
	public List<ItemStack> getDrops(BlockState state, LootContext.Builder builder) {
		...
		return Collections.singletonList(new ItemStack(MineboundModItems.GOLD_ORE.get()));
	}
