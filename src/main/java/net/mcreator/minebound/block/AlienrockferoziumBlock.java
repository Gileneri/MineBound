...
public class AlienrockferoziumBlock extends Block {
	public AlienrockferoziumBlock() {
		super(BlockBehaviour.Properties.of(Material.STONE, MaterialColor.TERRACOTTA_LIGHT_BLUE)
				.sound(new ForgeSoundType(1.0f, 1.0f, () -> new SoundEvent(new ResourceLocation("minebound:ore_breaking1_2")), () -> new SoundEvent(new ResourceLocation("minebound:footstep_rock")),
				...
				.strength(5.5f, 10f).requiresCorrectToolForDrops());
	}
	...
	public List<ItemStack> getDrops(BlockState state, LootContext.Builder builder) {
		...
		return Collections.singletonList(new ItemStack(MineboundModItems.FEROZIUM_ORE.get()));
	}
