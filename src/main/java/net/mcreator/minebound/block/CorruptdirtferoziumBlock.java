...
public class CorruptdirtferoziumBlock extends Block {
	public CorruptdirtferoziumBlock() {
		super(BlockBehaviour.Properties.of(Material.STONE, MaterialColor.TERRACOTTA_ORANGE)
				.sound(new ForgeSoundType(1.0f, 1.0f, () -> new SoundEvent(new ResourceLocation("minebound:ore_breaking1_2")), () -> new SoundEvent(new ResourceLocation("minebound:footstep_dirt")),
