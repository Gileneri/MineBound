...
public class AlienrockdiamondBlock extends Block {
	public AlienrockdiamondBlock() {
		super(BlockBehaviour.Properties.of(Material.STONE, MaterialColor.DIAMOND)
				...
				.strength(20.5f, 10f).requiresCorrectToolForDrops());
	}
	...
	public List<ItemStack> getDrops(BlockState state, LootContext.Builder builder) {
		...
		return Collections.singletonList(new ItemStack(MineboundModItems.SB_DIAMOND.get()));
	}
