...
public class BlaststoneVioliumBlock extends Block {
	public BlaststoneVioliumBlock() {
		super(BlockBehaviour.Properties.of(Material.STONE, MaterialColor.TERRACOTTA_PURPLE)
	...
	public List<ItemStack> getDrops(BlockState state, LootContext.Builder builder) {
		...
		return Collections.singletonList(new ItemStack(MineboundModItems.VIOLIUM_ORE.get()));
	}
