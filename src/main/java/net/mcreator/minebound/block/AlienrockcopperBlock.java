...
public class AlienrockcopperBlock extends Block {
	public AlienrockcopperBlock() {
		super(BlockBehaviour.Properties.of(Material.STONE, MaterialColor.TERRACOTTA_PINK)
	...
	public List<ItemStack> getDrops(BlockState state, LootContext.Builder builder) {
		...
		return Collections.singletonList(new ItemStack(MineboundModItems.COPPER_ORE.get()));
	}
