...
public class BlaststoneTitaniumBlock extends Block {
	public BlaststoneTitaniumBlock() {
		super(BlockBehaviour.Properties.of(Material.STONE, MaterialColor.COLOR_LIGHT_GRAY)
				...
				.strength(14f, 10f).requiresCorrectToolForDrops());
	}
	...
	public List<ItemStack> getDrops(BlockState state, LootContext.Builder builder) {
		...
		return Collections.singletonList(new ItemStack(MineboundModItems.TITANIUM_ORE.get()));
	}
