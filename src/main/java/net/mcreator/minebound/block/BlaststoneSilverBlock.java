...
public class BlaststoneSilverBlock extends Block {
	public BlaststoneSilverBlock() {
	...
	public List<ItemStack> getDrops(BlockState state, LootContext.Builder builder) {
		...
		return Collections.singletonList(new ItemStack(MineboundModItems.SILVER_ORE.get()));
	}
