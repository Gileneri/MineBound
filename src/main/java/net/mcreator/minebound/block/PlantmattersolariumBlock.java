...
public class PlantmattersolariumBlock extends Block {
	public PlantmattersolariumBlock() {
	...
	public List<ItemStack> getDrops(BlockState state, LootContext.Builder builder) {
		...
		return Collections.singletonList(new ItemStack(MineboundModItems.SOLARIUM_ORE.get()));
	}
